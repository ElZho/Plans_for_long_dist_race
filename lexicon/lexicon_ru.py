LEXICON_RU: dict[str, str] = {
    ...
    'help_for_authorized_user': 'Доступные команды:\n/fillform - начать рассчет плана\n'
                                ...
                                '/plan_my_race -  рассчитать план на гонку',

    'admins_commands': '/get_my_users',
    ...
    'make_week_completed': ['План на {}-ю неделю до старта выполнен.',
                            'План на {}-ю неделю до старта выполнен. Удачного старта!'],
    ...
    'plan_my_race': ['Укажи дистанцию.\nНапример, 21.1 - 21 км. 100 м.', 'Дистанция {}км {}м.\nВведите планируемое'
                    ' время.\nНапример, 010555 - 1 час 5 мин 55 сек.', 'План на {}км {}м.'],
